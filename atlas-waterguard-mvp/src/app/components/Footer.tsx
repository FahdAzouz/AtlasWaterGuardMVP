                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
                    <div>
                        <div className="flex items-center mb-4">
                            ...
                            <span className="ml-2 text-xl font-bold">Atlas WaterGuard</span>
                        </div>
                        <p className="text-gray-400 mb-4">
                            Empowering Moroccan farmers to combat water scarcity through AI-driven irrigation and economic incentives.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="#impact" className="text-gray-400 hover:text-white transition-colors duration-300">Impact</Link>
                            </li>
                            <li>
                                <Link href="#team" className="text-gray-400 hover:text-white transition-colors duration-300">Team</Link>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Tutorials</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Community Forum</a>
                            </li>
                            <li>
                    ...
                    <div>
                        ...
                        <form className="flex">
                            <input
                                ...
                                className="px-4 py-2 rounded-l-lg bg-gray-800 text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 flex-grow"
                            />
                            <button
                                type="submit"
                ...
                <div className="border-t border-gray-800 pt-6">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p className="text-gray-500 text-sm">
                            © {new Date().getFullYear()} Atlas WaterGuard. All rights reserved.
                        </p>
